    ...
    const loadCart = () => {
      try {
        ...
        if (storedCart) {
          ...
          const cartWithProducts = parsedCart.map((item: {id: number, quantity: number}) => ({
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-gray-50 rounded-lg">
            <Icon name="ShoppingBag" className="h-16 w-16 mx-auto text-gray-400 mb-4" />
            <h2 className="text-2xl font-medium text-gray-800 mb-2">Ваша корзина пуста</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div>
                  {cartItems.map((item) => (
                    <div key={item.product.id} className="p-6 border-b border-gray-200">
                      <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <div className="flex-grow">
                          <div className="flex flex-col sm:flex-row justify-between mb-2">
                            ...
                            <span className="font-medium text-purple-600">{item.product.price} ₽</span>
                          </div>
                          
                          <p className="text-sm text-gray-500 mb-4">Категория: {item.product.category}</p>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="mb-6">
                    ...
                    {promoApplied && (
                      <p className="text-green-600 text-sm mt-1">Промокод успешно применен!</p>
                    )}
                  </div>
