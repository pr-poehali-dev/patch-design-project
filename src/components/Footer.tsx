...
const Footer = ({ categories }: FooterProps) => {
  return (
    <footer className="bg-russian-blue text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
          <div className="md:col-span-4">
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-white to-russian-red bg-clip-text text-transparent">
              ЭМБРОТЕКА
            </h3>
            <p className="text-gray-300 mb-4">
              Профессиональные дизайны для вышивальных машин всех марок.
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-400 mb-4">
              Подпишитесь, чтобы получать уведомления о новых дизайнах и
